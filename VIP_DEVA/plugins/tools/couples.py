...
#BOT FILE NAME
from VIP_DEVA import app as app
from VIP_DEVA.mongo.couples_db import _get_image, get_couple
    ...
    try:
     ...
     #  if not is_selected:
         ...
         try:
            ...
            p1 = "VIP_DEVA/assets/bg.png"
         try:
            p2 = await app.download_media(photo2.big_file_id, file_name="pfp1.png")
         except Exception:
            p2 = "VIP_DEVA/assets/bg.png"
            
         img1 = Image.open(f"{p1}")
         img2 = Image.open(f"{p2}")

         img = Image.open("VIP_DEVA/assets/cplInnocy.jpg")
