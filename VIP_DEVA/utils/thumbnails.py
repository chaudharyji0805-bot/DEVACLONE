...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VIP_DEVA/assets/font2.ttf", 30)
    font = ImageFont.truetype("VIP_DEVA/assets/font.ttf", 30)
    title_font = ImageFont.truetype("VIP_DEVA/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("VIP_DEVA/assets/play_icons.png")
